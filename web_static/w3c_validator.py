...
def __analyse(file_path):
    """Starts analysis of a file and print the result
    """
    nb_errors = 0
    try:
        result = None
...
def __files_loop():
    """Loop for analysing for each file from input arguments
    """
    nb_errors = 0
...
if __name__ == "__main__":
    ...
    """executing tests, then exit. Exit status = # of errors (0 on success)
    """
